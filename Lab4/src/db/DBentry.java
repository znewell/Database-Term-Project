...
public class DBentry {
	...
	public boolean checkLogin(String [] login)
	{
	    ...
	    try{
	        ...
	        PreparedStatement pst = dbconn.prepareStatement("Select f_name,coach_id from login where f_name=? and coach_id=?");
	        pst.setString(1, login[0]);
	        pst.setString(2, login[1]);
